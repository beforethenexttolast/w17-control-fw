...
9. **Showcase mode — board-1 half (boot-selected stationary demo)** — ✅ software DONE
   ...
   joins the A2 continuity-matrix scope, F20). **Dated update, 2026-09-03: D3 was decided
   ...
   record of the wave that deferred the decision.** Also **deliberately NOT in this wave** —
   same list, unbroken by the dated-update note above — is any **NVS boot-mode override**:
   `src/main.cpp` today injects a
